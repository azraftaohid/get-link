		...
		<footer id="footer" className="mt-auto py-4">
			<Container id="footer-container" className="d-flex flex-column">
				<div className="d-flex flex-row mx-auto">
					<FooterAction onClick={() => setShowReport(true)}>Feedback</FooterAction>
					<div className="vr" />
					<FooterAction href="/policies" target="_blank">
						Policies
					</FooterAction>
					<div className="vr" />
					<FooterAction href="https://www.facebook.com/getlinksoft" target="_blank" rel="noreferrer noopener">
						Facebook
					</FooterAction>
					<div className="vr" />
					<FooterAction href="https://github.com/azraftaohid/get-link" target="_blank" rel="noreferrer noopener">
						Source
					</FooterAction>
				</div>
				<small className="text-center text-muted">
					Author{" "}
					<a className="text-reset" href="https://github.com/azraftaohid" target="_blank" rel="noreferrer noopener">
						Azraf Taohid
					</a>
				</small>
			</Container>
