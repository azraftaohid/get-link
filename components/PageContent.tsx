...
export const PageContent: React.FunctionComponent<React.PropsWithChildren<PageContentProps>> = ({
	className,
	size = "xl",
	children,
	...rest
	...
	return (
		<Container
			className={mergeNames("page-content", styles.pageContent, `py-4 mw-${size}`, className)}
			fluid={size}
			{...rest}
		>
			{children}
